...
{{-- Judul Tab --}}
@section('judul_tab','Wisata Buatan')
{{-- Judul Tab --}}
  ...
  <div class="container mt-lg-5">
    ...
    <div class="card" style="border: 1px solid black">
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <img src="{{ asset('image/buatan.jpg') }}" alt="" style="border: 1px solid black; border-radius:4px; height:450px;">
                </div>
                <div class="col-md-8">
                    <h3 style="font-weight:500; color:#193A6F">Pantai Pasir Putih Sibolahotang</h3>
