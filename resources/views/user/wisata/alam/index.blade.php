...
<div class="uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light" data-src="{{ asset('image/all.png') }}" uk-img width="1920" height="1000">
  ...
  <div class="container mt-lg-5">
    <h2 class="d-flex justify-content-center" style="font-weight:625; color:#193A6F">Wisata Alam</h2>
    <br>
    ...
    <div class="card" style="border: 1px solit black">
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <img src="{{ asset('image/all.png') }}" alt="" style="border: 1px solid black; border-radius:4px; height:450px">
                </div>
                <div class="col-md-8">
                    <h3 style="font-weight:500; color:#193A6F">Pantai II</h3>
                    <p>Pasir putih yang berada dipinggiran pantai ini dan panorama alam yang indah menjadikannya sebuah potensi dan daya tarik wisata, selain itu pantai ini juga cocok untuk dijadikan tempat olahraga air karena airnya yang cukup dangkal dan tenang. Pantai Bulbul memiliki ukuran sekitar 865 meter.</p>
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <h3 style="font-weight:500; color:#193A6F; line-height: 0.1; margin-top:68px;">Kapasitas Pengunjung</h3>
    ...
    <div class="card" style="border: 1px solit black">
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <img src="{{ asset('image/profil.png') }}" alt="" style="border: 1px solid black; border-radius:4px; height:450px">
                </div>
                <div class="col-md-8">
                    <h3 style="font-weight:500; color:#193A6F">Pantai III</h3>
                    <p>Pasir putih yang berada dipinggiran pantai ini dan panorama alam yang indah menjadikannya sebuah potensi dan daya tarik wisata, selain itu pantai ini juga cocok untuk dijadikan tempat olahraga air karena airnya yang cukup dangkal dan tenang. Pantai Bulbul memiliki ukuran sekitar 865 meter.</p>
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <h3 style="font-weight:500; color:#193A6F; line-height: 0.1; margin-top:68px;">Kapasitas Pengunjung</h3>
